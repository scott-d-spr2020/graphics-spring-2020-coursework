	...
	a3f32 const textAlign, a3f32 const textDepth, a3f32 const textOffsetDelta, a3f32 textOffset)
{
	...
	case demoState_materials:
		a3materials_render_controls(demoState, demoState->demoMode_materials, textAlign, textDepth, textOffsetDelta, textOffset);
		break;
	}
...
void a3demo_render(a3_DemoState const* demoState)
{
	...
	case demoState_keyframes:
		...
		break;
	case demoState_materials:
		a3materials_render(demoState, demoState->demoMode_materials);
	}
