...
void a3demo_loadFramebuffers(a3_DemoState* demoState)
{
	...
	for (i = 0; i < 3; ++i)
	{
		...
		a3framebufferCreate(fbo, "fbo:ssao",
			targets_composite, colorType_scene, a3fbo_depthDisable,
			frameWidth1, frameHeight1);
...
#pragma endregion
		...
		jointParentIndex = pelvisJointIndex;														   
		jointParentIndex = a3hierarchySetNode(hierarchy, jointIndex++, jointParentIndex, "skel_creeper:BR_knee");
...
#pragma region base_skel_poses
	...
	j = a3hierarchyGetNodeIndex(hierarchy, "skel:shoulder_r");
	hierarchyNodePose = hierarchyPoseGroup->pose[p].nodePose + j;
	a3hierarchyNodePoseSetRotation(hierarchyNodePose, 0.0f, +53.5f, -10.0f, a3true);
	a3hierarchyNodePoseSetTranslation(hierarchyNodePose, +0.5f, 0.0f, +0.5f);
	hierarchyPoseFlag[j] = a3poseFlag_rotate;
	j = a3hierarchyGetNodeIndex(hierarchy, "skel:elbow_r");
	hierarchyNodePose = hierarchyPoseGroup->pose[p].nodePose + j;
	a3hierarchyNodePoseSetRotation(hierarchyNodePose, 0.0f, 58.5f, +20.0f, a3true);
	a3hierarchyNodePoseSetTranslation(hierarchyNodePose, +2.0f, 0.0f, 0.0f);
	hierarchyPoseFlag[j] = a3poseFlag_rotate;
	j = a3hierarchyGetNodeIndex(hierarchy, "skel:forearm_r");
	hierarchyNodePose = hierarchyPoseGroup->pose[p].nodePose + j;
	...
	j = a3hierarchyGetNodeIndex(hierarchy, "skel:wrist_r");
	hierarchyNodePose = hierarchyPoseGroup->pose[p].nodePose + j;
	a3hierarchyNodePoseSetRotation(hierarchyNodePose, 0.0f, 25.5f, -10.0f, a3true);
	a3hierarchyNodePoseSetTranslation(hierarchyNodePose, +1.0f, 0.0f, 0.0f);
	hierarchyPoseFlag[j] = a3poseFlag_rotate;
	j = a3hierarchyGetNodeIndex(hierarchy, "skel:hand_r");
	hierarchyNodePose = hierarchyPoseGroup->pose[p].nodePose + j;
	...
	j = a3hierarchyGetNodeIndex(hierarchy, "skel:shoulderblade_l");
	hierarchyNodePose = hierarchyPoseGroup->pose[p].nodePose + j;
	a3hierarchyNodePoseSetTranslation(hierarchyNodePose, -0.5f, +0.15f, -0.5f);
	hierarchyPoseFlag[j] = a3poseFlag_translate;
	j = a3hierarchyGetNodeIndex(hierarchy, "skel:shoulder_l");
	hierarchyNodePose = hierarchyPoseGroup->pose[p].nodePose + j;
	a3hierarchyNodePoseSetRotation(hierarchyNodePose, +6.0f, -52.0f, -39.5f, a3true);
	a3hierarchyNodePoseSetTranslation(hierarchyNodePose, -0.5f, 0.0f, +0.5f);
	hierarchyPoseFlag[j] = a3poseFlag_rotate;
	j = a3hierarchyGetNodeIndex(hierarchy, "skel:elbow_l");
	hierarchyNodePose = hierarchyPoseGroup->pose[p].nodePose + j;
	a3hierarchyNodePoseSetRotation(hierarchyNodePose, 0.0f, -6.0f, -43.0f, a3true);
	a3hierarchyNodePoseSetTranslation(hierarchyNodePose, -2.0f, 0.0f, 0.0f);
	hierarchyPoseFlag[j] = a3poseFlag_rotate;
	j = a3hierarchyGetNodeIndex(hierarchy, "skel:forearm_l");
	hierarchyNodePose = hierarchyPoseGroup->pose[p].nodePose + j;
	...
	j = a3hierarchyGetNodeIndex(hierarchy, "skel:wrist_l");
	hierarchyNodePose = hierarchyPoseGroup->pose[p].nodePose + j;
	a3hierarchyNodePoseSetRotation(hierarchyNodePose, 0.0f, 0.0f, -14.0f, a3true);
	a3hierarchyNodePoseSetTranslation(hierarchyNodePose, -1.0f, 0.0f, 0.0f);
	hierarchyPoseFlag[j] = a3poseFlag_rotate;
	j = a3hierarchyGetNodeIndex(hierarchy, "skel:hand_l");
	hierarchyNodePose = hierarchyPoseGroup->pose[p].nodePose + j;
...
#pragma endregion
	...
	demoState->demoMode_keyframes->editSkeletonIndex = 0;
	hierarchy = demoState->hierarchy_skel_creeper + demoState->demoMode_keyframes->editSkeletonIndex;
	hierarchyPoseGroup = demoState->hierarchyPoseGroup_skel_creeper + demoState->demoMode_keyframes->editSkeletonIndex;
#define POSE_COUNT_CREEPER 2
	a3hierarchyPoseGroupCreate(hierarchyPoseGroup, hierarchy, POSE_COUNT_CREEPER);
	hierarchyPoseFlag = demoState->hierarchyPoseFlag_skel_creeper[demoState->demoMode_keyframes->editSkeletonIndex];
	...
	j = a3hierarchyGetNodeIndex(hierarchy, "skel_creeper:FL_knee");
	hierarchyNodePose = hierarchyPoseGroup->pose[p].nodePose + j;
	a3hierarchyNodePoseSetRotation(hierarchyNodePose, -75.0f, 0.0f, +53.0f, a3true);
	a3hierarchyNodePoseSetTranslation(hierarchyNodePose, +0.75f, -0.1f, +0.5f);
	hierarchyPoseFlag[j] = a3poseFlag_rotate;
	j = a3hierarchyGetNodeIndex(hierarchy, "skel_creeper:FL_toe");
	hierarchyNodePose = hierarchyPoseGroup->pose[p].nodePose + j;
	...
	hierarchyPoseGroup = demoState->hierarchyPoseGroup_skel_creeper + demoState->demoMode_keyframes->editSkeletonIndex;
	hierarchyState = demoState->hierarchyState_skel_creeper + demoState->demoMode_keyframes->editSkeletonIndex;
	a3hierarchyStateCreate(hierarchyState, hierarchyPoseGroup);
}
